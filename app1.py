...
from pmt import generate_coding_questions, evaluate_coding_answer
from pmt import generate_technical_questions, evaluate_technical_answers
from pmt import generate_hr_questions, evaluate_hr_answers,generate_coding_hint
import os
...
from pmt import generate_mcq_questions, generate_coding_questions
...
def generate_questions_llm(round_type, company):
    ...
    if round_type=='mcq':
        # Call your LLM pmt function for MCQs
...
from pmt import generate_reading_paragraph, generate_topic, generate_fill_in_blanks, generate_listening_questions
